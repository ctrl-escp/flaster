...
<template>
  ...
  >
    ...
    >
      ...
      <div class="help-body">
        <section class="help-section" aria-labelledby="help-overview-heading">
          <h3 id="help-overview-heading">What flASTer does</h3>
          <dl class="mode-list">
            <div class="mode-row">
        ...
        <section class="help-section" aria-labelledby="help-workflow-heading">
          <h3 id="help-workflow-heading">Workflow</h3>
        ...
        <section class="help-section" aria-labelledby="help-shortcuts-heading">
